...
class CpuidFieldsIntel extends CpuidFieldsBase
{
	...
	#cpuid_07_ebx_fields = [
		...
		new CpuidField("Reserved", [28,26], null, { reserved: true }),
		...
		new CpuidField("Arbitrary precision arithmetic (ADX)", 19, CpuidBaseResolvers.bool),
		new CpuidField("RDSEED", 18, CpuidBaseResolvers.bool),
		new CpuidField("Reserved", [17,16], null, { reserved: true }),
		new CpuidField("Resource director technology allocation (RDT-A) capability", 15, CpuidBaseResolvers.bool),
		...
		new CpuidField("Resource director technology monitoring (RDT-M) capability", 12, CpuidBaseResolvers.bool),
	...
	#cpuid_07_ecx_fields = [
		...
		new CpuidField("Reserved", [29,23], null, { reserved: true }),
		...
		new CpuidField("Reserved", [16,5], null, { reserved: true }),
		...
		new CpuidField("Reserved", 1, null, { reserved: true }),
